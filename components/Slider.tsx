...
export default function Slider() {
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      <main>
        {/* Navigation Mock */}
        <nav className="w-full py-6 px-8 flex justify-between items-center bg-white border-b border-gray-100 mb-10">
          <div className="text-xl font-bold font-serif">Motion</div>
          <div className="hidden md:flex gap-6 text-sm uppercase tracking-wide text-gray-500">
            <span>Home</span>
            <span>Shop</span>
            <span>About</span>
          </div>
        ...
        <footer className="w-full py-12 text-center text-gray-400 text-sm mt-20 border-t border-gray-200">
          © 2024 Motion Theme Replica
        </footer>
      </main>
    </div>
  );
